...
$(document).ready(function() {
    togglemenu();
    if ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) { togglemenulayout() }
    menuhrres();
    var e = $(window)[0].innerWidth;
    $('[data-toggle="tooltip"]').tooltip();
    $('[data-toggle="popover"]').popover();
    $(".to-do-list input[type=checkbox]").on("click", function() { if ($(this).prop("checked")) { $(this).parent().addClass("done-task") } else { $(this).parent().removeClass("done-task") } });
    $(".mobile-menu").on("click", function() {
        var g = $(this);
        g.toggleClass("on")
    });
    $("#mobile-collapse").on("click", function() { $(".pcoded-navbar:not(.theme-horizontal)").toggleClass("navbar-collapsed") });
    $(".search-btn").on("click", function() {
        var g = $(this);
        $(".main-search").addClass("open");
        if (e <= 991) { $(".main-search .form-control").css({ width: "90px" }) } else { $(".main-search .form-control").css({ width: "150px" }) }
    });
    ...
    $("#m-search").on("keyup", function() {
        ...
        $(".pcoded-inner-navbar > li").each(function() { var g = $(this).attr("data-username"); if (g) { var j = g.toLowerCase() } if (j) { var k = j.indexOf(i); if (k !== -1) { $(this).show() } else { $(this).hide() } if (h > 0) { $(".pcoded-menu-caption").hide() } else { $(".pcoded-menu-caption").show() } } })
    });
    ...
    $(".h-send-chat").on("keyup", function(g) { c(g) });
    $(".btn-send").on("click", function(g) { b(g) });
    if (e <= 991) {
        $(".main-search").addClass("open");
        $(".main-search .form-control").css({ width: "120px" })
    }
    if ($(".main-friend-cont")[0]) { $(".main-friend-cont").each(function() { var g = new PerfectScrollbar(this, { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) }) }
    if ($(".main-chat-cont")[0]) { var a = new PerfectScrollbar(".main-chat-cont", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) }
    if ($(".noti-body")[0]) { var a = new PerfectScrollbar(".notification  .noti-body", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) }
    if (!$(".pcoded-navbar").hasClass("theme-horizontal")) { var e = $(window)[0].innerWidth; if ($(".navbar-content")[0]) { if (e < 992 || $(".pcoded-navbar").hasClass("menupos-static")) { var a = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) } else { var a = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) } } }

    function c(g) { if (g.which == 13) { b(g) } }
    ...
    $(".card-option .close-card").on("click", function() {
        ...
        setTimeout(function() { g.parents(".card").remove() }, 1500)
    });
    ...
    $(".card-option .minimize-card").on("click", function() {
        ...
        if (!g.hasClass("full-card")) { $(g).css("height", "auto") }
    ...
    $(".card-option .full-card").on("click", function() {
        ...
        if (h.hasClass("full-card")) {
            ...
            $("body").css("overflow", "");
            h.removeAttr("style");
            setTimeout(function() { $("html,body").animate({ scrollTop: ($(h).offset().top) - 70 }, 500) }, 400)
        }
    });
...
function menuhrres() {
    ...
    setTimeout(function() { if ($(".pcoded-navbar").hasClass("theme-horizontal-dis")) { $(".sidenav-horizontal-wrapper-dis").css({ height: "100%", position: "relative" }); if ($(".sidenav-horizontal-wrapper-dis")[0]) { var b = new PerfectScrollbar(".sidenav-horizontal-wrapper-dis", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) } } }, 1000)
}
var ost = 0;
$(window).scroll(function() {
    ...
    if (b >= 768) {
        ...
        if (a == 400) { $(".theme-horizontal").addClass("top-nav-collapse") } else { if (a > ost && 400 < ost) { $(".theme-horizontal").addClass("top-nav-collapse").removeClass("default") } else { $(".theme-horizontal").addClass("default").removeClass("top-nav-collapse") } }
        ost = a
    }
});

function togglemenu() { var a = $(window)[0].innerWidth; if ($(".pcoded-navbar").hasClass("theme-horizontal") == false) { if (a <= 1200 && a >= 992) { $(".pcoded-navbar:not(.theme-horizontal)").addClass("navbar-collapsed") } if (a < 992) { $(".pcoded-navbar:not(.theme-horizontal)").removeClass("navbar-collapsed") } } }
        ...
        HandleSubMenuTrigger: function() {
            ...
            if ($(".pcoded-navbar").hasClass("theme-horizontal") == true || $(".pcoded-navbar").hasClass("theme-horizontal-dis") == true) {
                if ((e >= 992 && $("body").hasClass("layout-6") || (e >= 992 && $("body").hasClass("layout-7")))) {
                    ...
                    f.off("click").off("mouseenter mouseleave").hover(function() { $(this).addClass("pcoded-trigger").addClass("active") }, function() { $(this).removeClass("pcoded-trigger").removeClass("active") })
                } else {
            ...
            if (e >= 992) {
                if ($(".pcoded-navbar").hasClass("theme-horizontal") == true) {
                    if ((e >= 768 && $("body").hasClass("layout-6") || (e >= 768 && $("body").hasClass("layout-7")))) {
                        ...
                        }, function() { $(this).removeClass("pcoded-trigger").removeClass("active") })
                    } else {
                        if ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) {
                            if ($(".pcoded-navbar").hasClass("theme-horizontal-dis")) {
        ...
        HandleOffset: function() {
            switch (a.themelayout) {
                case "horizontal":
                    ...
                    if (e === "hover") { $("li.pcoded-hasmenu").on("mouseenter mouseleave", function(k) { if ($(".pcoded-submenu", this).length) { var n = $(".pcoded-submenu:first", this); var m = n.offset(); var g = m.left; var f = n.width(); var j = $(window).height(); var h = $(window).width(); var i = (g + f <= h); if (!i) { $(this).addClass("edge") } else { $(this).removeClass("edge") } } }) } else { $("li.pcoded-hasmenu").on("click", function(k) { k.preventDefault(); if ($(".pcoded-submenu", this).length) { var n = $(".pcoded-submenu:first", this); var m = n.offset(); var g = m.left; var f = n.width(); var j = $(window).height(); var h = $(window).width(); var i = (g + f <= h); if (!i) { $(this).toggleClass("edge") } } }) }
                    break;
                default:
            }
        },
...
$(window).ready(function() {
    var a = $(window)[0].innerWidth;
    $(".pcoded-navbar").on("click tap", function(b) { b.stopPropagation() });
...
$("#mobile-collapse1").click(function(b) {
    ...
    if ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) {
        setTimeout(function() {
            if (a <= 992) { $(".pcoded-navbar:not(.theme-horizontal-dis)").removeClass("mob-open") }
            if (a > 992) {
...
$("#show-toggle").on("click", function() { $(".pcoded-navbar:not(.theme-horizontal-dis)").toggleClass("mob-open-h") });
if ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) { if ($(".navbar-content")[0]) { var px = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) } }
...
function togglemenulayout() { var a = $(window)[0].innerWidth; if ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) { if (a <= 1200 && a >= 992) { $(".pcoded-navbar:not(.theme-horizontal)").addClass("navbar-collapsed") } if (a < 992) { $(".pcoded-navbar:not(.theme-horizontal)").removeClass("navbar-collapsed") } } }
$("body.layout-8 .pcoded-navbar .dropdown-toggle").on("click", function() { $(this).siblings(".dropdown-menu").addClass("show") });
$(document).mouseup(function(b) { var a = $("body.layout-8 .pcoded-navbar .dropdown-menu"); if (!a.is(b.target) && a.has(b.target).length === 0) { a.removeClass("show") } });
...
if (vw < 992) {
    ...
    } else { $(".pcoded-header > .collapse:not(.show)").append('<a href="#!" class="mob-toggler"></a>') }
}
...
$(".pcoded-header > .collapse:not(.show) .mob-toggler").click(function() { $(".pcoded-header > .collapse:not(.show) > ul").slideToggle(1) });
$(".pcoded-header > .container>.collapse:not(.show) .mob-toggler").click(function() { $(".pcoded-header > .container> .collapse:not(.show) > ul").slideToggle(1) });
if (vw >= 992) { $(".layout-14 .pcoded-inner-navbar > li.pcoded-hasmenu").unbind("click") }
...
function clrpop() { $(".navbar-popup").remove() }
$(".layout-14 .pcoded-navbar").on("mouseleave", function() { clrpop() });
$(".layout-14 .pcoded-inner-navbar > li:not(.pcoded-hasmenu)").on("mouseenter", function() { clrpop() });
